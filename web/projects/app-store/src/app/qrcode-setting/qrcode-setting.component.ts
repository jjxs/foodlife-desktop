...
@Component({
  selector: 'app-qrcode-setting',
  templateUrl: './qrcode-setting.component.html',
  styleUrls: ['./qrcode-setting.component.css']
})
export class QrcodeSettingComponent implements OnInit {
