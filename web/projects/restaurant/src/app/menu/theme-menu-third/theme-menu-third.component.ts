...
@Component({
  selector: 'restaurant-theme-menu-third',
  templateUrl: './theme-menu-third.component.html',
  styleUrls: ['./theme-menu-third.component.css'],
  animations: [
...
export class ThemeMenuThirdComponent implements OnInit, OnChanges {
