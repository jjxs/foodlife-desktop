...
@Component({
  selector: 'restaurant-theme-menu-kosu',
  templateUrl: './theme-menu-kosu.component.html',
  styleUrls: ['./theme-menu-kosu.component.css'],
  animations: [
...
export class ThemeMenuKosuComponent implements OnInit, OnChanges {
