...
@Component({
  selector: 'restaurant-theme-menu-top-image',
  templateUrl: './theme-menu-top-image.component.html',
  styleUrls: ['./theme-menu-top-image.component.css']
})
export class ThemeMenuTopImageComponent implements OnInit {
